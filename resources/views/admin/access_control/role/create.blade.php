                        ...
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item">
                                <button style="margin-right: 9px;" class="btn btn-info pull-right">
                                    <a style="color: #ffffff;" href="{{ route('role.index') }}"><i class="fa fa-reply" aria-hidden="true"></i></a>
                                </button>
                            </li>
                        </ol>
                    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="card-box">
                            <div id="vue_app">
                                <hr>
                                {!! BootForm::open(['model' => $model, 'store' => 'role.store', 'update' => 'role.update']); !!}

                                <div class="row">
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 offset-lg-4 offset-md-4 offset-sm-4">
                                    {!!  BootForm::text('name', 'Role Name (Must be unique)', null, ['placeholder'=>'Enter name','required'=>'required'] ) !!}
                                    </div>
