                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="from_date" class="form-control float-right datepicker" id="datepicker" autocomplete="off">
                                    </div>
                                    <!-- /.input group -->
                                </div>
                            </div>
                           <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="to_date" type="text" class="form-control float-right datepicker" autocomplete="off">
                                    </div>
                                    <!-- /.input group -->
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12" style="margin-top:32px;">
                             ...
                             <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12" style="margin-top:32px;">
                               <a href="{{ route('purchase.report') }}" class="btn btn-block btn-success">Refresh</a>
                            </div>
                        </div>
                    </form>
                        <div class="row">
